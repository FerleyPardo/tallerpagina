        ...
        <div class="container">
            <div class="row align-items-center py-5">
                <div class="col-md-8 text-white">
                    ...
                    <p>
                        En CICLO_RAR, estamos apasionados por el ciclismo y comprometidos con brindar a 
                        nuestros clientes la mejor experiencia en dos ruedas. 
                        Desde que abrimos nuestras puertas por primera vez en 2020, hemos 
                        estado sirviendo a la comunidad de amantes de las bicicletas en GIRARDOT-CUNDINAMARCA
                        con una amplia gama de bicicletas, accesorios y servicios de alta calidad.
                    </p>
                </div>
                <div class="col-md-4">
    ...
    <section class="container py-5">
        <div class="row text-center pt-5 pb-3">
            <div class="col-lg-6 m-auto">
                ...
                <p>
                    Nuestro taller de reparación está equipado con herramientas 
                    de última generación y personal altamente capacitado para 
    ...
    <section class="bg-light py-5">
        <div class="container my-4">
            <div class="row text-center py-3">
                <div class="col-lg-6 m-auto">
                    <h1 class="h1">Accesorios de Calidad</h1>
                    <p>
                        Ofrecemos una amplia gama de accesorios, desde cascos 
                        y candados hasta ropa ciclista y componentes de alta gama.
                    </p>
                </div>
